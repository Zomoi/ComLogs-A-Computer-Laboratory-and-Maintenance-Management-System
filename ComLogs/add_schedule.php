...
if ($_POST) {
    try {
        ...
        $stmt = $pdo->prepare("
            INSERT INTO maintenance_schedules (device_type, device_ids, maintenance_type, scheduled_date, assigned_to, created_by)
            VALUES (?, ?, ?, ?, ?, 1)
        ");
        $stmt->execute([$device_type, $device_ids_str, $maintenance_type, $scheduled_date, $assigned_to]);
...
<head>
    ...
    <title>Add Maintenance Schedule - ComLogs</title>
    <style>
        body {
    ...
    <div class="form-container">
        ...
        <form method="POST" id="scheduleForm">
            ...
            <div class="form-group">
                ...
                <input type="text" id="maintenance_type" name="maintenance_type" placeholder="e.g., Hardware Check, System Update" required>
            </div>
...
<script>
        ...
        function loadDevices() {
            ...
            const idField = type === 'computer' ? 'id' : 'id';
        ...
        // Load initial devices (computers)
        loadDevices();
    </script>
</body>
</html>