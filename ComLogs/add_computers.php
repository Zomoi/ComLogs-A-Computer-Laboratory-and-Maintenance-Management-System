...
if ($_POST) {
    try {
        ...
        $stmt = $pdo->prepare("
            INSERT INTO computers (pc_name, ip_address, mac_address, location, status)
            VALUES (?, ?, ?, ?, ?)
        ");
        $stmt->execute([$pc_name, $ip, $mac, $location, $status]);

        $message = "Computer added successfully!";
        // Redirect after success (prevent resubmission)
...
<head>
    ...
    <title>Add Computer - ComLogs</title>
    <style>
        body {
    ...
    <div class="form-container">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="mac_address" name="mac_address" required placeholder="e.g., 00:1A:2B:3C:4D:5E">
            </div>

            <div class="form-group">
                <label for="location">Location *</label>
                <input type="text" id="location" name="location" required placeholder="e.g., Lab 1">
            </div>
